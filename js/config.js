...
const REP_LEVELS = [
  ...
  {min:5,   label:'🐛 Červ z Křemže',        color:'#7a8a6e'},
  {min:10,  label:'🚬 Nikdo důležitý',       color:'#a3e635'},
  {min:18,  label:'🧹 Školníkův pomocník',   color:'#88bb44'},
  {min:22,  label:'🍺 Místní problém',        color:'#fb923c'},
  {min:30,  label:'🎤 Křemžský rapper',       color:'#e08830'},
  {min:38,  label:'💊 Frajer Fanda',          color:'#f43f5e'},
  {min:46,  label:'🃏 Žolík',                color:'#dd3388'},
  {min:55,  label:'👑 Křemžská legenda',      color:'#a855f7'},
  {min:64,  label:'🎯 Snajpr na žemle',       color:'#9944ee'},
  {min:72,  label:'🔥 Boss',                 color:'#f97316'},
  {min:82,  label:'🐺 Vlk z Křemže',         color:'#ee6622'},
  {min:90,  label:'💀 UltraMegaBoss',        color:'#f0c040'},
  {min:105, label:'⚡ Blesk nad Křemží',      color:'#ffdd00'},
  {min:120, label:'🌋 Apokalypsa v Křemži',   color:'#ff2222'},
  {min:140, label:'🦅 Orel Křemžský',         color:'#ff4444'},
  {min:160, label:'👹 Absolutní Degenerát',   color:'#ff00ff'},
  {min:180, label:'🧨 Dynamit Fanda',         color:'#ff33cc'},
  {min:200, label:'🛸 Mimozemská hrozba',     color:'#00ffff'},
  {min:230, label:'🏴‍☠️ Pirát jihu Čech',       color:'#00dddd'},
  {min:260, label:'🧙 Arcimág Křemže',        color:'#44ddff'},
  {min:300, label:'💎 Diamantový Fanda',      color:'#00ff88'},
  {min:350, label:'🐉 Drak z Blaníku',        color:'#33ff66'},
  {min:400, label:'⭐ Hvězdný praotec',       color:'#ffff44'},
  {min:450, label:'🔱 Neptun Křemžský',       color:'#66ffcc'},
  {min:500, label:'🌌 Vesmírný Bůh Křemže',  color:'#ffffff'},
  {min:600, label:'🪐 Meziplanetární Fanda',  color:'#ff88ff'},
  {min:750, label:'💫 Supernova',             color:'#ffffaa'},
  {min:1000,label:'∞ Nekonečný Hrubeš',       color:'#ffd700'},
];
